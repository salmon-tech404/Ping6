...
export function SignupForm({
  ...
  return (
    <div className={cn("flex flex-col gap-8", className)} {...props}>
          ...
          <form className='p-6 md:p-8' onSubmit={handleSubmit(onSubmit)}>
            <div className='flex flex-col gap-4'>
              ...
              <div className='flex flex-col items-center text-center gap-6 mb-4'>
                ...
                <h1 className='text-2xl font-bold'>Tạo tài khoản Ping6</h1>
                <p className='text-muted-foreground text-balance'>
                  Chào mừng bạn đến với Ping6! Hãy đăng ký để bắt đầu những trải
                  nghiệm thú vị.
                </p>
              </div>
      ...
      {/* colume 2 */}
      <div className='px-6 text-center text-xs text-balance'>
